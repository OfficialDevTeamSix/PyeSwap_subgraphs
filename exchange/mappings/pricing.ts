...
import {ZERO_BD, factoryContract, ADDRESS_ZERO, ONE_BD, ZERO_BI} from "./utils";
...
export function getBnbPriceInUSD(): BigDecimal {
  ...
  let busdTryReserves = busdPair.try_getReserves()

  if (!busdTryReserves.reverted) {
    let busdReserves = busdTryReserves.value
    let price = busdReserves.value0.notEqual(ZERO_BI)
        ? (busdReserves.value1.toBigDecimal().div(busdReserves.value0.toBigDecimal()))
        : ZERO_BD
...
let WHITELIST: string[] = [
  ...
  "0x8076C74C5e3F5852037F31Ff0093Eeb8c8ADd8D3", // SFM
